    ...
    ($name:tt, $cipher:tt, $tlen:tt) => {
        ...
        impl $name {
            ...
            fn calc_offset_0(&self, nonce: &[u8]) -> [u8; Self::BLOCK_LEN] {
                ...
                match bottom {
                    0 => {
                        offset_0[0..Self::BLOCK_LEN]
                            .copy_from_slice(&stretch[0..Self::BLOCK_LEN + 0]);
                    }
                    8 => {
                        offset_0[0..Self::BLOCK_LEN]
                            .copy_from_slice(&stretch[1..Self::BLOCK_LEN + 1]);
                    }
                    16 => {
                        offset_0[0..Self::BLOCK_LEN]
                            .copy_from_slice(&stretch[2..Self::BLOCK_LEN + 2]);
                    }
                    24 => {
                        offset_0[0..Self::BLOCK_LEN]
                            .copy_from_slice(&stretch[3..Self::BLOCK_LEN + 3]);
                    }
                    32 => {
                        offset_0[0..Self::BLOCK_LEN]
                            .copy_from_slice(&stretch[4..Self::BLOCK_LEN + 4]);
                    }
                    40 => {
                        offset_0[0..Self::BLOCK_LEN]
                            .copy_from_slice(&stretch[5..Self::BLOCK_LEN + 5]);
                    }
                    48 => {
                        offset_0[0..Self::BLOCK_LEN]
                            .copy_from_slice(&stretch[6..Self::BLOCK_LEN + 6]);
                    }
                    56 => {
                        offset_0[0..Self::BLOCK_LEN]
                            .copy_from_slice(&stretch[7..Self::BLOCK_LEN + 7]);
                    }
                    64 => {
                        offset_0[0..Self::BLOCK_LEN]
                            .copy_from_slice(&stretch[8..Self::BLOCK_LEN + 8]);
                    }
                    _ => {
                        // Slow path
...
fn test_aes128_ocb_tag128_enc() {
    ...
    assert_eq!(
        &ciphertext_and_tag[..],
        &hex::decode("785407BFFFC8AD9EDCC5520AC9111EE6").unwrap()[..]
    );
    ...
    assert_eq!(
        &ciphertext_and_tag[..],
        &hex::decode("6820B3657B6F615A5725BDA0D3B4EB3A257C9AF1F8F03009").unwrap()[..]
    );
    ...
    assert_eq!(
        &ciphertext_and_tag[..],
        &hex::decode("81017F8203F081277152FADE694A0A00").unwrap()[..]
    );
    ...
    assert_eq!(
        &ciphertext_and_tag[..],
        &hex::decode("45DD69F8F5AAE72414054CD1F35D82760B2CD00D2F99BFA9").unwrap()[..]
    );
...
701C1CCEC8FC3358"
    ...
    assert_eq!(
        &ciphertext_and_tag[..],
        &hex::decode("8CF761B6902EF764462AD86498CA6B97").unwrap()[..]
    );
...
C92C62241051F57356D7F3C90BB0E07F"
    ...
    assert_eq!(
        &ciphertext_and_tag[..],
        &hex::decode("6DC225A071FC1B9F7C69F93B0F1E10DE").unwrap()[..]
    );
...
18191A1B1C1D1E1F",
    ...
    assert_eq!(
        &ciphertext_and_tag[..],
        &hex::decode("FE80690BEE8A485D11F32965BC9D2A32").unwrap()[..]
    );
...
18191A1B1C1D1E1F2021222324252627",
    ...
    assert_eq!(
        &ciphertext_and_tag[..],
        &hex::decode("C5CD9D1850C141E358649994EE701B68").unwrap()[..]
    );
