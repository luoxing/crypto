...
use crate::blockcipher::{
    Aes128, Aes192, Aes256, Aria128, Aria192, Aria256, Camellia128, Camellia192, Camellia256, Sm4,
};
        ...
        impl $name {
            ...
            pub fn encrypt(&self, iv: &[u8; Self::IV_LEN], segments: &mut [u8]) {
                ...
                for segment in data.chunks_mut(Self::SEGMENTS_LEN) {
                    ...
                    tmp[0..Self::BLOCK_LEN - Self::SEGMENTS_LEN]
                        .copy_from_slice(&last_input_block[Self::SEGMENTS_LEN..]);
